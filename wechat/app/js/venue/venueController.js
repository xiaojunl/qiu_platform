 ...
 * 预定场地
 */
wechatApp.controller('reservVenueCtrl', ['$scope','$http','$controller',
    function($scope,$http,$controller) {
        ...
        //$scope.$on('ngRepeatFinished',function(ngRepeatFinishedEvent) {
            ...
            var Scroll2 = new iScroll('scroll2',{hScrollbar:false,hScroll:false,vScroll:true,checkDOMChanges:true});
        ...
        $scope.initmap=function(point){
            ...
            gc.getLocation(point, function(rs){
                ...
                $scope.initVenueData(addComp.city);
                //$scope.initVenueData("上海市");
            });
        }
         ...
         * @param city
         */
        $scope.loadVenueList=function(vId){
            var interfaceName="/venue/near";
            ...
            $scope.getApi(interfaceName,params,function(data,status){
                ...
                //    $scope.venueList.push(data.data[i]);
                //}
                if(vId!=null&&vId!=""){
        ...
        $scope.initVenueData=function(city){
            $scope.cityTip="全城";
